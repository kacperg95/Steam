        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescriptionCensored = table.Column<string>(type: "text", nullable: true),
                    ...
                    LastUpdateSuccessful = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalUnlockPercentage = table.Column<double>(type: "double precision", nullable: false),
                    GameId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => new { x.Id, x.VideoUrl });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_ReviewScore",
                table: "Games",
                column: "ReviewScore");

            migrationBuilder.CreateIndex(
                name: "IX_Games_TotalReviews",
                table: "Games",
                column: "TotalReviews");

            migrationBuilder.CreateIndex(
                name: "IX_Games_TotalReviews_ReviewScore",
                table: "Games",
                columns: new[] { "TotalReviews", "ReviewScore" });
